...
\begin{frame}{Coordinate Transformations}
	\begin{itemize}
		% The Einstein field equations are covariant under general 4D coordinate transformations
		\item Under $x^\mu \to x'^\mu$
		\begin{eqnarray}
			g'_{\mu\nu}(x') = \frac{\partial x^\alpha}{\partial x'^\mu}\frac{\partial x^\beta}{\partial x'^\nu}g_{\alpha\beta}(x)
		\end{eqnarray}
		\item 	Under coordinate transformation $x^\mu \to x^\mu - \epsilon^\mu(x)$, with $\nabla_\mu \epsilon_\nu \sim \mathcal O(h)$
		%it is conveinent to attribute the entire change in g_{\mu\nu}(x) to a change in the perturbation $h_{\mu\nu}$. 
			\begin{eqnarray}
				g'_{\mu\nu}(x) - g_{\mu\nu}(x) &\equiv& \Delta h_{\mu\nu}(x)
			\end{eqnarray}
		% The field equations are thus to be invariant under the so call gauge transformation
...
\begin{frame}[label=svt3ds4]{SVT3 $\delta G_{\mu\nu}$ in a de Sitter Background}
	...
	\end{itemize}
		...
		\end{eqnarray}
		\begin{eqnarray}
		R_{\lambda\mu\nu\kappa} = H^2 (g_{\mu\nu}g_{\lambda\kappa}-g_{\lambda\nu}g_{\mu\kappa}),\qquad  R_{\mu\kappa} = -3H^2 g_{\mu\kappa},\qquad R=-12H^2
		\end{eqnarray}
	}
	\begin{itemize}
...
\begin{frame}{SVT3 $\delta G_{\mu\nu}$ in a de Sitter Background}
	\begin{itemize}
		\item Decouple by applying higher derivatives
		\begin{eqnarray}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\normalsize{
			\item Perturb $\delta G_{\mu\nu}$ and $\delta T_{\mu\nu}$ around de Sitter background
			\item Decompose $h_{\mu\nu}$ into SVT3 components
			\item Compose $\Delta_{\mu\nu} = \delta G_{\mu\nu} + \delta T_{\mu\nu} = 0$ 
			\item Apply higher derivatives to decouple SVT3 representations
		}
		\end{itemize}
	\end{itemize}
	}
...
\begin{frame}{SVT3 Integral Formulation}
	\begin{itemize}
		\item SVT3 in a Minskowski background, 
		\begin{eqnarray}
			h_{00} &=& -2\phi,
			\nonumber\\
			h_{0i} &=& B_i + \partial_i B
			\nonumber\\
...
\begin{frame}{SVT3 Integral Formulation}
	...
	\begin{itemize}
		\item Longitudinal decomposition does not hold for any scalar. $\partial^i V_i = \partial_i\partial^i V=0$
	\end{itemize}
	\visible<2->{
	\begin{itemize}
	...
	\begin{itemize}
		...
		\nonumber\\
		&\implies& \oint dS_i[V(x')\partial^i D(x-x') - D(x-x')\partial^i V(x')] = 0
		\end{eqnarray}
...
\begin{frame}{SVT4 Setup}
	\begin{itemize}
		...
		\begin{enumerate}
			\begingroup
			\normalsize
			\item Generalize to $D=4$ \vspace{1mm}
			\item Generalize to curved space backgrounds
			\begin{eqnarray}
...
\begin{frame}{SVT3 vs. SVT4 $\delta G_{\mu\nu}$ de Sitter}
	\begin{itemize}
		\item SVT3
			\begin{eqnarray}
			\Delta_{00}&=&-\frac{6}{\tau^2}(\dot{\beta}-\alpha)-\frac{2}{\tau}\tilde{\nabla}^2\beta=0,
...
\begin{frame}{Conformal Gravity Introduction}
	\begin{itemize}
		...
		\boxed{4\alpha_g\left[W^{\mu
			\nu}_{(2)}-\frac{1}{3}W^{\mu\nu}_{(1)}\right]=T^{\mu\nu}}
			\quad \footnote{Compare to $R^{\mu\nu}-\frac{1}{2}g^{\mu\nu}R = T^{\mu\nu}$.\\ P Mannheim. Alternatives to dark matter and dark energy. \textit{Progress in Particle and Nuclear Physics}, 56(2):340–445, 2006.}
		\end{eqnarray}
		\begin{eqnarray}
		W^{\mu \nu}_{(1)}&=&
...
\begin{frame}{Trace Properties in Conformal Gravity}
	\begin{itemize}
		...
		\begin{eqnarray}
		K_{\mu\nu}(x)=h_{\mu\nu}(x)-\frac{1}{4}g^{(0)}_{\mu\nu}(x)g_{(0)}^{\alpha\beta}h_{\alpha\beta},\qquad h_{\mu\nu} = K_{\mu\nu} + \frac{1}{4}h g_{\mu\nu}
		\end{eqnarray}
		\begin{eqnarray}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Slide  - SVT3 Integral Formulation
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
