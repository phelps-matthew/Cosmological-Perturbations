...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Slide  - SVT3 Integral Formulation 3/3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{SVT3 Integral Formulation}
	...
	\end{eqnarray}
	\item Make definitions, $D\equiv D(x-x')$
	\end{itemize}
	\begin{eqnarray}
...
\begin{frame}{SVT4 Setup}
	\begin{itemize}
		...
		\qquad
		h_{0\mu} = \begin{pmatrix}-2\phi\\B_1 + \partial_1 B\\B_2 + \partial_2 B\\B_3 + \partial_3 B\end{pmatrix}
		\end{eqnarray}
		\item We seek to 
		\begin{enumerate}
			\begingroup
