\documentclass[8pt,aspectratio=1610,draft]{beamer}
...
\begin{frame}{SVT3 Integral Formulation}
	...
	\begin{itemize}
		...
		\item Introduce Green's function $\partial_i \partial^i D(x-x') = \delta^3(x-x')$ and Green's identity
		\begin{eqnarray*}
		...
		\end{eqnarray*}
		\begin{eqnarray*}
		V = V^{NH} + V^{H},\qquad \partial_i\partial^i V = \partial_i\partial^i V^H,\qquad \partial_i\partial^i V^{NH} = 0
		\end{eqnarray*}
