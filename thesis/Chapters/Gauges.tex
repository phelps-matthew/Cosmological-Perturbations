...
%%%%%%%%%%%%%%%%%
\footnote{Such suppression in this case can be viewed as the following: if $\chi$ is negligible then so is $r$, and thus spatial part of the metric in (\ref{A4}) effectively becomes flat.}
%%%%%%%%%%%%%%%.
