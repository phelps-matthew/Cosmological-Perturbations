...
\noindent 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{$T,R$ Coordinates}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{eqnarray}
ds^2 &=& -dt^2 + a^2(t)\left( \frac{dr^2}{1+r^2/L^2} + r^2d\theta^2 + r^2\sin^2\theta d\phi^2\right)
\\ \nonumber\\
p &=& \frac{\tau}{L},\qquad \sinh\chi = \frac{r}{L},\qquad \tau = \int \frac{dt}{a(t)}
\\ \nonumber\\
ds^2 &=& L^2 a^2(p)( -dp^2 + d\chi^2 + \sinh^2\chi d\theta^2 + \sin^2\chi \sin^2\theta d\phi^2)
\\ \nonumber\\
T&=& e^p \cosh\chi,\qquad R= e^p\sinh\chi,\qquad X^2 \equiv T^2-R^2 = e^{2p}
\\ \nonumber\\
\sinh\chi &=& \frac{R}{X},\qquad \cosh\chi = \frac{T}{X}
\\ \nonumber\\
ds^2 &=& L^2 \frac{a^2(X)}{X^2}(-dT^2+dR^2+ R^2d\theta^2 + R^2\sin^2\theta d\phi^2)
\\ \nonumber\\
\Omega(X) &=& L\frac{a(X)}{X}
\end{eqnarray}
...
\label{geom}
\\ \nonumber\\
G_{00}&=& -3 \dot{\Omega}^2 \Omega^{-2} + 2 \Omega^{-1} \tilde{\nabla}_{a}\tilde{\nabla}^{a}\Omega -  \Omega^{-2} \tilde{\nabla}_{a}\Omega \tilde{\nabla}^{a}\Omega 
\\  \nonumber\\ 
G_{0i}&=& 2 \Omega^{-1} \tilde{\nabla}_{i}\dot{\Omega} - 4 \dot{\Omega} \Omega^{-2} \tilde{\nabla}_{i}\Omega 
\\  \nonumber\\ 
G_{ij}&=& - \dot{\Omega}^2 \tilde{g}_{ij} \Omega^{-2} + 2 \overset{..}{\Omega} \tilde{g}_{ij} \Omega^{-1} - 2 \tilde{g}_{ij} \Omega^{-1} \tilde{\nabla}_{a}\tilde{\nabla}^{a}\Omega + \tilde{g}_{ij} \Omega^{-2} \tilde{\nabla}_{a}\Omega \tilde{\nabla}^{a}\Omega - 4 \Omega^{-2} \tilde{\nabla}_{i}\Omega \tilde{\nabla}_{j}\Omega \nonumber \\ 
&& + 2 \Omega^{-1} \tilde{\nabla}_{j}\tilde{\nabla}_{i}\Omega 
\\  \nonumber\\ 
g^{\mu\nu}G_{\mu\nu}&=& 6 \overset{..}{\Omega} \Omega^{-3} - 6 \Omega^{-3} \tilde{\nabla}_{a}\tilde{\nabla}^{a}\Omega 
\\ \nonumber\\
U'_\mu(T,R) &=& \frac{\partial x^\alpha}{\partial x'^\mu}\left( -a(\tau)\delta^0_\alpha\right) 
= -\frac{\partial \tau}{\partial x'^\mu} a(X)
\\ \nonumber\\
U_\mu (T,R) &=& \Omega \left( -\frac{T}{X},\frac{R}{X},0,0  \right)
\\ \nonumber\\
